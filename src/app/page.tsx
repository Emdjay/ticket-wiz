        ...
        <div className="mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center gap-8 px-6 py-16 text-center">
          ...
          <div className="mt-6 flex w-full justify-center">
            <div className="grid w-full max-w-3xl gap-3 rounded-2xl border border-[#D9E2EA] bg-white/80 p-4 text-center text-xs text-[#363535] shadow-sm">
              ...
              <div>
                <div className="font-semibold text-[#000034]">How do you find deals?</div>
                <div>
                  We compare price, duration, and stops, then rank options by a deal score.
                </div>
              </div>
              <div>
                <div className="font-semibold text-[#000034]">Do you sell tickets?</div>
                <div>No. We send you to partner sites to complete booking.</div>
              </div>
              <div>
                <div className="font-semibold text-[#000034]">Are prices final?</div>
